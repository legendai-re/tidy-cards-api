...
for (let i in invalidUsernames) { tryUpdateInvalidUsername(invalidUsernames[i]) }
...
for (let i in invalidUsernames) { tryInvalidUsername(invalidUsernames[i]) }
...
for (let i in validUsernames) { tryValidUsername(validUsernames[i]) }
...
for (let i in invalidEmails) { tryInvalidEmail(invalidEmails[i]) }
...
for (let i in validEmails) { tryValidEmail(validEmails[i]) }
